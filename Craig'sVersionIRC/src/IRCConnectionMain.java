        ...
        while(true)
        {
           ...
           {  
               ...
               if(user != null)
               {
                   ...
                   else if(actionTok.equals("DAC") ) // it is a audio connection, if the next parameters are ok!
                   {
                       try
                       {
                           int ip = Integer.parseInt(tok.nextToken());
                        ...
                        try
                       {
                           ...
                           guiConnection.openFileConnection(user,GetClientIP.intToIpAdress(ip), port);
